...
// ** Form
import AddStoreForm from './form/AddStoreFrom'
    ...
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Store</CardTitle>
        </CardHeader>
      ...
      >
        <ModalHeader>
          <CardTitle>{editData ? 'Edit Store' : 'Add New Store'}</CardTitle>
        </ModalHeader>
        <ModalBody>
          <AddStoreForm formData={editData} />
        </ModalBody>
      </Modal>
    </Fragment>
  )
